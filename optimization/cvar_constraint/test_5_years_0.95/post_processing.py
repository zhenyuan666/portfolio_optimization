...
if __name__ == "__main__":
    ...
    plt.xlim((1990, 2015))
    plt.ylim((0, 55))
    plt.savefig('cvar_cumulative.jpg', dpi=600)
    plt.show()
    plt.close("all")
    ...
    plt.savefig('cvar_sr.jpg', dpi=600)
    plt.show()
    plt.close("all")
    ...
    plt.xticks([1991, 1995, 2000, 2005, 2010, 2015])
    #plt.ylim((0, 50))
    plt.savefig('cvar_c_return.jpg', dpi=600)
    plt.show()
    plt.close("all")
    ...
    plt.xlim((1991, 2015))
    plt.xticks([1991, 1995, 2000, 2005, 2010, 2015])
    plt.savefig('cvar_monthly_return.jpg', dpi=600)
    plt.show()
    plt.close("all")
    ...
    plt.xticks([1991, 1995, 2000, 2005, 2010, 2015])
    plt.ylim((0, 0.09))
    plt.savefig('cvar_monthly_std.jpg', dpi=600)
    plt.show()
    plt.close("all")
    ...
    plt.xlim((1991, 2015))
    plt.xticks([1991, 1995, 2000, 2005, 2010, 2015])
    plt.savefig('cvar_monthly_num_asset.jpg', dpi=600)
    plt.show()
    plt.close("all")
